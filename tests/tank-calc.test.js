...
var waterCalc = require(path.join(__dirname, "..", "assets", "calc.js"));
var waterDefaults = require(path.join(__dirname, "..", "assets", "defaults.js"));
var calc = require(path.join(__dirname, "..", "assets", "tank-calc.js"));
var defaults = require(path.join(__dirname, "..", "assets", "tank-defaults.js"));
